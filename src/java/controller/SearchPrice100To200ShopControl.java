 ...
 * @author admin
 */
@WebServlet(name="SearchPrice100To200ShopControl", urlPatterns={"/searchPrice100To200Shop"})
public class SearchPrice100To200ShopControl extends HttpServlet {
...
out.println("</style>");
        ...
        out.println("<div class=\"product-list\">");out.println("<div class=\"product-list\">");
        for (Product o : list) {
