                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4" id="contentTotalMoney">
                                        ...
                                        <c:forEach items="${listCart}" var="o">
                                            <c:forEach items="${listProduct}" var="p">
                                                <c:if test="${o.productID == p.id}">
                                                    <c:set var="totalPrice" value="${totalPrice + (p.price * o.amount)}"/>
                                                </c:if>
                                            </c:forEach>
                                        </c:forEach>
                                        <c:set var="totalTax" value="${totalPrice * 0.9}"/>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng tiền</strong><strong>${totalPrice}$</strong></li>
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng hóa đơn bao gồm VAT</strong><strong>${totalTax}$</strong></li>
