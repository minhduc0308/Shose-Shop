...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
 ...
 <!-- Carousel wrapper -->
  ...
  <div class="card" style="border-style: none;">
    <img style="height:55px; width:64px; margin: auto;" src="https://th.bing.com/th/id/R.77324b7bffe240d5a698091928296d44?rik=fdlLXNIjIY9u5g&riu=http%3a%2f%2fthesplendidlifestyle.com%2fwp-content%2fuploads%2f2019%2f08%2fdelivery.png&ehk=6it3QaR03%2bUA%2fYaNsq5JJQvYeFoIx8eusDr1b59eMps%3d&risl=&pid=ImgRaw&r=0">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://cdn.tgdd.vn/hoi-dap/1307810/Thumbnail/ship-cod-la-gi-uu-nhuoc-diem-ra-sao-quy-trinh-mua-chuyenthumbne.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://png.pngtree.com/png-clipart/20210311/original/pngtree-warranty-seal-icon-png-image_6058257.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card" style="border-style: none;">
    <img class="card-img-top" style="height:55px; width:64px; margin: auto;" src="https://th.bing.com/th/id/R.7350dcdfd72b4fa62416a6853a2dd29c?rik=Wv5payunYre%2f8w&pid=ImgRaw&r=0" alt="Card image cap">
    <div class="card-body">
             ...
             <div class="row" style="margin-top:50px">            
                    <div class="col-sm-12">
                        <div id="content" class="row">
                            ...
                            <div class=" col-12 col-md-12 col-lg-6">
                                    <img class="card-img-top" src="https://sneakerdaily.vn/wp-content/uploads/2023/02/z4137113891445_cf87ff5c3b2c70ed179e1d1a48d087b3.jpg.webp" alt="Card image cap">        
                            </div>
                    </div>
                </div>
            </div>
